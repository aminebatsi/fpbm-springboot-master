...
public class ExcelExportEtdModWtFillndSem extends AbstractXlsView
{
    private String filliere;
    private String semestre;

    public ExcelExportEtdModWtFillndSem(String filliere, String semestre) {
    ...
    protected void buildExcelDocument(
        ...
        for(ProfesseurHasModuleHasEtudiant spec : listModule) {
            if(spec.getProfesseurHasModule_id().getModule().getSemestre().getName_semester().equals(this.semestre) &&
                    spec.getProfesseurHasModule_id().getModule().getSemestre().getFillier_id().getName().equals(this.filliere)){
